...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex items-center bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 overflow-hidden">
      ...
      <div className="absolute top-1/3 left-1/3 w-64 h-64 bg-green-500/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }} />

      {/* Geometric shapes */}
      <div className="absolute top-32 left-[20%] w-16 h-16 border border-white/20 rounded-xl rotate-45 animate-pulse" style={{ animationDuration: '6s' }} />
      <div className="absolute bottom-48 right-[15%] w-12 h-12 border border-white/20 rounded-full animate-pulse" style={{ animationDuration: '5s', animationDelay: '1s' }} />

      <div className="relative z-10 max-w-7xl mx-auto px-4 w-full" style={{ transform: `translateY(${scrollY * 0.15}px)` }}>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              {stats.map((stat) => (
                <div key={stat.label}>
                  ...
                  <div className="flex items-center gap-1.5 mt-1">
                    <stat.icon size={12} className="text-blue-300" />
          ...
          <div className="hidden lg:block relative">
            ...
            <div className="absolute -bottom-4 -right-4 bg-white rounded-2xl p-5 shadow-xl animate-bounce" style={{ animationDuration: '4s' }}>
